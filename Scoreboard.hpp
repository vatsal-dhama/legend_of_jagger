...
class Scoreboard
{
	...
	TTF_Font *gFont = TTF_OpenFont( "C:\\IIITB\\Second year- first sem\\Cpp\\Project\\Rahul and anshul\\assets\\hii.otf", 44);;
    TTF_Font *gFont1 = TTF_OpenFont("C:\\IIITB\\Second year- first sem\\Cpp\\Project\\Rahul and anshul\\assets\\hii.otf",44);
		//Image dimensions
		int mWidth;
		int mHeight;
};